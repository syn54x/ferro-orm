...
- Specific tests:
  ...
  - `Covers AE: UUID parse failure raises PyValueError with stable diagnostic`.
...
| Risk                                                                                                                                         | Mitigation                                                                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Decimal                                                                                                                                     | None`binds as`float8`-typed NULL, not` numeric`; wire OID change can churn pgbouncer prepared-statement caches.                                                                 |
