...
async def test_query_delete(db_url):
    ...
    # Delete matching
    deleted_count = await DeletableUser.where(DeletableUser.username == "delete_1").delete()
    deleted_count += await DeletableUser.where(DeletableUser.username == "delete_2").delete()
