...
from ferro import Model, connect, FerroField, reset_engine, clear_registry, ForeignKey, BackRelationship
...
def test_relationship_validation_failure():
    ...
    from ferro.relations import resolve_relationships
    with pytest.raises(Exception, match="defines a relationship to 'User' with related_name='posts'"):
        resolve_relationships()
